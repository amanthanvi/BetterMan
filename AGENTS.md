...
- **Node.js 26** is required (not 22). Install via `nvm install 26 && nvm alias default 26`.
- **Python 3.14** is required. Install via `uv python install 3.14`.
- **pnpm 10.34.4** is pinned in `package.json`; install via `npm install -g pnpm@10.34.4` after switching to Node 26.
