...
- Reliability: restore the monthly dataset schedule, gate promotion on all selected ingests, add a non-active FreeBSD VM sample path, and enforce Playwright/OSV automation contracts in CI.
- Security: upgrade transitive `brace-expansion` 5.x to 5.0.9 for GHSA-rgw5-rvv9-x895.
