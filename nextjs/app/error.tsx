...
export default function Error({
  ...
  return (
    <div className="min-h-[70dvh] px-6 py-16 text-[var(--bm-fg)]">
      <div className="mx-auto max-w-3xl rounded-3xl border border-[var(--bm-border)] bg-[color:var(--bm-surface)/0.75] p-6 shadow-sm backdrop-blur">
        ...
        <p className="mt-3 text-sm text-[color:var(--bm-muted)]">Try again, or go back home.</p>
        {error.digest ? (
          <div className="mt-3 font-mono text-xs text-[color:var(--bm-muted)]">Digest: {error.digest}</div>
        ) : null}
