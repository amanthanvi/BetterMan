  ...
  return (
    <li className="rounded-md border border-[var(--bm-border)] bg-[var(--bm-surface)] p-4 transition-colors hover:border-[var(--bm-border-accent)]">
      <div className="flex flex-col gap-2">
        ...
        {synopsis ? (
          <pre className="overflow-x-auto rounded-[var(--bm-radius)] border border-[var(--bm-border)] bg-[var(--bm-surface-2)] p-3 font-mono text-xs leading-[1.6] text-[color:var(--bm-fg)]">
