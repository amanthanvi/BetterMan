...
- `BETTERMAN_DATASET_STAGE` (set on the Convex deployment; public reads default to `prod`)
- `BETTERMAN_DATASET_STAGE` (set separately in the ingestion process to choose its authenticated write target)
