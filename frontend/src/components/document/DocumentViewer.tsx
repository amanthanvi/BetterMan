      ...
      if (firstLine && firstLine.match(/^[A-Z][A-Z\s]+$/)) {
        ...
        return (
          <div key={index} className="mb-8">
            <h2 id={`section-${header.toLowerCase().replace(/\s+/g, '-')}`} 
            ...
            {tocItems.map((item) => (
              <button
                ...
                className={cn(
                  ...
                  item.id === activeSection && 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300',
                  item.level > 1 && 'ml-4',
                  item.level > 2 && 'ml-8'
                )}
              >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button
                ...
                className={isFavorite(document.id) ? 'text-yellow-500' : ''}
              >
                <StarIcon className={cn('w-4 h-4', isFavorite(document.id) && 'fill-current')} />
              </Button>
