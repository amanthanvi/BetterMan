...
export const SettingsPage: React.FC = () => {
  ...
  const handleExportData = () => {
    ...
    a.href = url;
    a.download = `betterman-data-${new Date().toISOString().split('T')[0]}.json`;
    a.click();
        ...
        <div className="space-y-8">
          ...
          >
            ...
            >
              <div className="flex space-x-2">
                <Button
                  variant={preferences.fontFamily === 'system' ? 'primary' : 'outline'}
                  size="sm"
                ...
                <Button
                  variant={preferences.fontFamily === 'mono' ? 'primary' : 'outline'}
                  size="sm"
                ...
                <Button
                  variant={preferences.fontFamily === 'serif' ? 'primary' : 'outline'}
                  size="sm"
